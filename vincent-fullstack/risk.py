"""
Heuristic risk-of-error scoring — same logic as the other prototypes, kept
in one place so frontend/backend behavior doesn't drift as this gets
replaced with real model confidence over time.
"""
...
def assess_risk(doc_type: str, content: str, extracted_fields: dict, extraction_confidence: dict):
    """Returns (risk_level: str, flags: list[dict])."""
    flags = []
